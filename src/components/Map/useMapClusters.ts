 ...
 * lookup rather than a rebuild - and the provider is only ever handed the pins inside the viewport.
 *
 * @param props Pins, whether to group them, the visible viewport and the grouping options.
 * @returns The pins to draw, with overlapping ones replaced by a single pin carrying the group.
 */
