...
import { getRouteThroughStops, IMapDirections } from './directions';
 ...
 * directions service leaves them straight, and a single route the service cannot resolve stays straight
 * while the others are snapped. A straight line is a worse drawing of the same truth, never a wrong one.
 *
 * @param props The routes, whether to snap them, and the service to snap with.
 * @returns The routes to draw, and whether any are still being resolved.
 */
