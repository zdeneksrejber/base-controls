...
import { getRouteThroughStops, IMapDirections } from '../../core/directions';
...
export interface IUseRoutePaths {
    routes: IMapRoute[];
...
export interface IRoutePathsState {
 ...
 * others are snapped.
 */
export const useRoutePaths = (props: IUseRoutePaths): IRoutePathsState => {
