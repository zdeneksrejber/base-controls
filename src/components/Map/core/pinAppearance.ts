 ...
 *
 * This is the shape the legacy MapPicker's `pinIcons` used, so an existing configuration carries over under the new name.
 */
 ...
 */
export const parseMapPinRules = (json?: string | null): IMapPinRule[] => parseMapRules<IMapPinRule>(json, 'PinRules');
