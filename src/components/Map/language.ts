...
/**
 * The language a geo-coding or routing service should answer in.
 *
 * @param languageId LCID the host reports through its user settings.
 * @returns A BCP 47 tag, or `undefined` to let the service pick - which is better than sending a wrong one.
 */
