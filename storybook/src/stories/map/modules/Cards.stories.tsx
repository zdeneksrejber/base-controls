...
const FieldsCard = () => {
    ...
    return (
        <MapDemo dataset={dataset} modules={FIELDS_CARD} parameters={{ ...COORDINATES, DefaultProvider: { raw: 'leaflet' } }}>
...
const AdaptiveCards = () => {
    ...
    const executed = useHostShim()
    return (
        <MapDemo dataset={dataset} modules={ADAPTIVE_CARD} parameters={{ ...COORDINATES, DefaultProvider: { raw: 'leaflet' } }}>
...
const RuledCards = () => {
    ...
    const executed = useHostShim()
    return (
        <MapDemo dataset={dataset} modules={RULED} parameters={{ ...COORDINATES, PinRules: { raw: PIN_RULES }, DefaultProvider: { raw: 'leaflet' } }}>
...
const GroupedCard = () => {
    ...
    return (
        <MapDemo dataset={dataset} modules={GROUPED} parameters={{ ...COORDINATES, PinRules: { raw: PIN_RULES }, DefaultProvider: { raw: 'leaflet' } }} />
    )
}
        ...
        docs: {
            description: {
                story: [
                    ...
                    'whatever `components.clusterMember` draws - with a button to zoom to where the group comes',
...
const DeletableCards = () => {
    ...
    return (
        <MapDemo dataset={dataset} modules={EDITABLE} parameters={{ ...COORDINATES, DefaultProvider: { raw: 'leaflet' } }} />
    )
}
